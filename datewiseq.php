...
<body>
    ...
    $sqlfetch = "SELECT * FROM addexp where Email='{$_SESSION['email']}' and Expense_Date BETWEEN '$firstdate' AND '$lastdate' ORDER BY Expense_Date LIMIT {$offset} , {$limit_per_page}";
    ...
    if ($nrows > 0 && $result1) {
        $boutput = "<input type='text' id='pages7' value='$page' hidden>
