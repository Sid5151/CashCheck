...
if (isset($_SESSION['loggedin']) || $_SESSION['loggedin'] == true) {
    ...
    if (isset($_POST['bsubmit'])) {
        ...
        if ($verifycode == $hiddencode) {
            ...
            $query = "INSERT INTO `login`(`First_Name`, `Last_Name`, `Email`,`Password`) VALUES ('{$_SESSION['fname2']}','{$_SESSION['lname2']}','{$_SESSION['email2']}','{$_SESSION['pass2']}')";
            ...
            if ($result) {
                ...
                echo "Sorry your details have not been inserted, since there is a techical difficulties...." . mysqli_error($conn);
            }
        }
    }
}
                                ...
                                <div class="card-body p-4 p-lg-5 text-black">
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="form-outline mb-4">
                                            ...
                                            <br>
                                            <h5 style="font-weight: 700;">Enter the verification code which has been send to <?php echo $_SESSION['email2'] ?></h5>
                                        </div>
