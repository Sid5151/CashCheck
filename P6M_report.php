...
<br><br>
<h2>This is list of Previous 6 Months Expenses for <i><u>" . $row1['First_Name'] . "</u></i></h2>
    <br>
...
//Set email subject
$mail->Subject = "Previous 6 Months Expenses";
//set sender email
...
$mail->addStringAttachment($pdf, "P6ME.pdf");
