...
$Current_Month_firstdate = date("Y/m/d", strtotime("first day of january this year"));

$Current_Month_lastdate = date("Y/m/d", strtotime("last day of december this year"));
...
<div class="container">
<h4>Expense_Type Sum of Money Spend for the Current_Year</h4>
