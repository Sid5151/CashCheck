...
<br><br>
<h2>This is list of all the expenses for the Current Year for <i><u>" . $row1['First_Name'] . "</u></i></h2>
    <br>
...
//Set email subject
$mail->Subject = "Current Year Expenses";
//set sender email
...
Within the folds of this PDF attachment lies a snapshot of your expenses from <em>Current Year Expenses</em> financial voyage. 🌙💰 <br>
...
$mail->addStringAttachment($pdf, "CurrentYearExpenses.pdf");
