...
<br><br>
<h2>This is list of all the expenses for the Previous 3 Months for <i><u>" . $row1['First_Name'] . "</u></i></h2>
    <br>
...
//Set email subject
$mail->Subject = "Previous 3 Months Expenses";
//set sender email
...
Within the folds of this PDF attachment lies a snapshot of your expenses from <em>Previous Month Expenses</em> financial voyage. 🌙💰 <br>
...
$mail->addStringAttachment($pdf, "P3ME.pdf");
