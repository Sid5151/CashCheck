...
<button name='prev' id='prev2' type='button' class='btn btn-outline-dark mx-2'>Previous</button>
<input type='text' id='total_pages2' value='$total_pages' hidden>
";

for ($i = 1; $i <= $total_pages; $i++) {
    $output2 .= "<a hidden id='$i'>$i</a>";
}
$output2 .= "<button  name='next' id='next2'  class='btn btn-outline-dark'>Next</button></div>";
echo $output2;
