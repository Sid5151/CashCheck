...
//its actually pm_first and lastdate
$Current_Month_firstdate = date("Y/m/d", strtotime("first day of -6 months"));

$Current_Month_lastdate = date("Y/m/d", strtotime("last day of last month"));
...
<div class="container">
<h4>Expense_Type Sum of Money Spend for the Previous 6 Months</h4>
