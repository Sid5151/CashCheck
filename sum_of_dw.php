...
$Current_Month_firstdate = $_POST['sd'];
$Current_Month_lastdate = $_POST['ed'];
...
<div class="container">
<h4>Expense_Type Sum of Money Spend from ' . $Current_Month_firstdate . ' to ' . $Current_Month_lastdate . '</h4>
