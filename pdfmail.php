...
<br><br>
<h2>This is list of all the expenses till date for <i><u>" . $row1['First_Name'] . "</u></i></h2>
    <br>
...
//Set email subject
$mail->Subject = "Expenses Till Date";
//set sender email
...
Within the folds of this PDF attachment lies a snapshot of your <em>past month's</em> financial voyage. 🌙💰 <br>
...
$mail->addStringAttachment($pdf, "expense_tilldate.pdf");
