...
<br><br>
<h2>This is list of all the expenses for the Current Month for <i><u>" . $row1['First_Name'] . "</u></i></h2>
    <br>
...
//Set email subject
$mail->Subject = "Current Month Expenses";
//set sender email
...
Within the folds of this PDF attachment lies a snapshot of your expenses from <em>Current Month Expenses</em> financial voyage. 🌙💰 <br>
...
$mail->addStringAttachment($pdf, "Current_Month_Expenses.pdf");
