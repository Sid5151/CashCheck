...
if (!isset($_SESSION['loggedin']) || !$_SESSION['loggedin'] == true) {
    ...
    if (isset($_POST['bsubmit'])) {
        ...
        if ($verifycode == $hiddencode) {
            ...
            $sanitized_password = mysqli_escape_string($conn, $_SESSION['password']);
                                ...
                                <div class="card-body p-4 p-lg-5 text-black">
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="form-outline mb-4">
                                            ...
                                            <br>
                                            <h5 style="font-weight: 700;">Enter the verification code which has been send to <?php echo $_SESSION['email'] ?></h5>
                                        </div>
